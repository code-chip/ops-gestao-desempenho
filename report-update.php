	...
	<tr>
		...
		<td><!--COLUNA NOME-->
			<div class="field">
				<fieldset disabled>					
				<div class="control">
					<input type="text" class="input" value="<?php echo $vtNome[$i]?>">
				</div>
				</fieldset>				
			</div>
		</td>		
		<td><!--COLUNA PRESENÇA-->
			<div class="field">
				<fieldset disabled>					
				<div class="control">
					<input type="text" class="input" value="<?php echo $vtPresenca[$i]?>">
				</div>
				</fieldset>				
			</div>
		</td>			
		<td class="field"><!--COLUNA ATIVIDADE-->
			<div class="field">
				<div class="control">
					<input type="text" class="input" value="<?php echo $vtAtividade[$i]?>">
				</div>
			</div>
		</td>
		<td>
			<div class="field" style="max-width:7em;"><!--COLUNA META-->
				<div class="control">
					<input type="text" class="input" value="<?php echo $vtMeta[$i]?>">
				</div>							
			</div>
		</td>
		<td><!--COLUNA ALCANÇADO-->	
			<div class="field">
				<div class="control">
					<input type="text" class="input" value="<?php echo $vtAlcancado[$i]?>">
				</div>
			</div>
		</td>
		<td><!--COLUNA DESEMPENHO-->
			<div class="field">
				<div class="control">
					<input type="text" class="input" value="<?php echo round($vtDesempenho[$i],2)."%"?>">
				</div>
			</div>
		</td>
		<td><!--COLUNA DATA-->	
			<div class="field">
				<div class="control">
					<input type="text" class="input" value="<?php echo $vtRegistro[$i]?>">
				</div>
			</div>
		</td>						
	</tr>
