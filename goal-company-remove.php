...
<head>
	...
	<title>Gestão de Desempenho - Remover Meta Empresa</title>
...
<body>
	<section class="section">
	  	<div class="container">
	  		<?php if (isset($_POST['consultar']) == null && isset($_POST['removerMeta']) == null) : ?>
	  		<form enctype="multipart/form-data" action="goal-company-remove.php" method="POST" id="form1">
			...
			if (isset($_POST['anoMes']) != null ) :
	  		...
	  		?>
	   		<form enctype="multipart/form-data" action="goal-company-remove.php" method="POST" id="form2" onsubmit="return check()">
				...
				<div class="field is-horizontal">
					...
					<div class="field-body">
						<div class="field is-grouped">							
							<div class="control">
								<button name="removerMeta" type="submit" class="button is-primary" value="Filtrar">Remover</button>
							</div>
							<div class="control">
								<a href="goal-company-remove.php" class="button is-primary">Voltar</a>
							</div>
							<div class="control">
...
if (isset($_POST["removerMeta"]) != null) {

	mysqli_query($phpmyadmin, "DELETE FROM META_EMPRESA WHERE ID = " . $_POST['id']);
	$erro = mysqli_error($phpmyadmin);
			
	if ($erro == "" && $erro == null) {
		echo "<script>alert('Meta Empresa removida com sucesso!'); window.location.href='metric.php';</script>";
	} else {
		echo $erro;
		echo "<script>alert('Erro ao remover Meta Empresa!');</script>";
	}
