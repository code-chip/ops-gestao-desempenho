...
<head>
	...
	<title>Gestão de Desempenho - Consultar Tipo de Penalidade</title>
...
<body>
	<section class="section">
	  	<div class="container">
	  		...
	  		<form enctype="multipart/form-data" action="penalty-type-query.php" method="POST" id="form1">
			...
			if (isset($_POST['penalidade']) != null ) :
	  		...
	  		?>
	   		<form enctype="multipart/form-data" action="penalty-type-query.php" method="POST" id="form2" onsubmit="return check()">
				...
				<div class="field is-horizontal">
					...
					<div class="field-body">
						<div class="field is-grouped">							
							<div class="control">
								<a href="penalty-type-query.php" class="button is-primary">Voltar</a>
							</div>
							<div class="control">
