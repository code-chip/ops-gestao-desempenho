			...
			<div class="field is-horizontal">				
				...
				<div class="field-body">
					<div class="field" style="max-width:17em;">							
						<div class="control">
							<div class="select">
								<select onchange="upPlaceholder(this.value)" name="filtro" style="width:16.7em;">
...
if( $busca != ""){
	...
	$query="SELECT *,USUARIO.ID AS ID, USUARIO.NOME AS NOME, T.NOME AS TURNO, P.NOME AS PERMISSAO, UG.NOME AS GESTOR, S.NOME AS SETOR, C.NOME AS CARGO FROM USUARIO
INNER JOIN TURNO T ON T.ID=USUARIO.TURNO_ID
INNER JOIN PERMISSAO P ON P.ID=USUARIO.PERMISSAO_ID
INNER JOIN USUARIO UG ON UG.ID=USUARIO.GESTOR_ID
