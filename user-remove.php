...
if(isset($_POST['search']) && $row != 0 || $_SESSION['permissao'] == 1 && $row!=0) : ?>
	<section class="section">
		<div class="container">
			<h3 class="title"><i class="fas fa-calendar-times"></i> Remover Usuário</h3>
		<hr>
	<main>
	<form id="form" action="user-remove.php" method="POST" onsubmit="return check()">
		<div class="field">
		...
		<div class="field-body">
			<div class="field is-grouped">
				<div class="control">
					<input name="remove" type="submit" class="button is-primary btn128" value="Remover"/>
				</div>
				<?php 
				if ( $_SESSION["permissao"] > 1){
					echo "<div class='control'>
						<a href='user-remove.php' class='button is-primary btn128'>Voltar</a>
					</div>";
				}
				?>
				<div class="control">
...
if (isset($_POST['remove'])) {	
	$result = mysqli_query($phpmyadmin, "DELETE FROM USUARIO WHERE ID=".$_SESSION["upUser"]);		 				
