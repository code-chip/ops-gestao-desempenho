...
<page size="A4">
	...
	<table class="table is-bordered pricing__table is-fullwidth borda">	
		...
		<tr>
			...
			<?php 
		echo "<img src='http://chart.apis.google.com/chart?chs=300x150&cht=p&chd=".$occurrence[$v]."&chl=".$activity[$v]."&chtt=Distribuição+das+atividades' width='33%' height='30%'>";
	
		echo "<img src='http://chart.apis.google.com/chart?chs=300x150&cht=bvg&chxt=x,y&chm=N,000000,0,-1,11&chd=".$b1_avg[$v]."&chl=".$b1_month[$v]."&chds=a&chtt=Desempenho+no+mês' width='33%' height='30%'>";

		echo "<img src='http://chart.apis.google.com/chart?chs=300x150&cht=lc&chxt=x,y&chm=N,000000,0,-1,11&chd=".$c1_access[$v]."&chl=".$c1_month[$v]."&chds=a&chtt=Acessos+no+sistema' width='33%' height='30%'>"; 
	?>
	<table class="table is-bordered pricing__table is-fullwidth borda">	
		<tr>
			<td><b>Folga's</b></td>
