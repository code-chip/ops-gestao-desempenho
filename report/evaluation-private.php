...
list($yearMonth, $userId)=explode('_', $_GET['filter'],2);
$userId = "AND AI.USUARIO_ID=".$userId; 
...
WHERE AII.USUARIO_ID =AI.USUARIO_ID AND AII.AVALIACAO_POR =AI.GESTOR_ID) AS LIDER_COMEN
FROM AVAL_INDICE AI
...
WHERE AI.SITUACAO = 'Finalizado' AND AI.AVALIACAO_POR = U.ID AND AI.ANO_MES='$yearMonth' ".$userId;
