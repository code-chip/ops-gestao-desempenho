...
<head>
	...
	<title>Gestão de Desempenho - Atualizar empresa</title>
...
<body>
	<section class="section">
	  	<div class="container">
	   		<form enctype="multipart/form-data" action="goal-weight-insert.php" method="POST" id="form2" onsubmit="return check()">
