...
AND REGISTRO <= CONCAT(DATE_FORMAT(DATE_SUB(CURDATE(),INTERVAL 2 MONTH),'%Y-%m'),'-20') AND PRESENCA_ID NOT IN (3,4)
UNION ALL
...
AND REGISTRO <= CONCAT(DATE_FORMAT(DATE_SUB(CURDATE(),INTERVAL 1 MONTH),'%Y-%m'),'-20') AND PRESENCA_ID NOT IN (3,4)
UNION ALL
...
AND REGISTRO <= CONCAT(DATE_FORMAT(CURDATE(),'%Y-%m'),'-20') AND PRESENCA_ID NOT IN (3,4)
UNION ALL
...
AND REGISTRO <= CONCAT(DATE_FORMAT(DATE_ADD(CURDATE(),INTERVAL 1 MONTH),'%Y-%m'),'-20') AND PRESENCA_ID NOT IN (3,4);";
...
WHERE PRESENCA_ID NOT IN(3,4) AND REGISTRO>=DATE_SUB('".$periodo."-21', INTERVAL 1 MONTH) AND REGISTRO<='".$periodo."-20' ".$turno."
...
WHERE PRESENCA_ID NOT IN (3,4) AND REGISTRO>=DATE_SUB('".$periodo."-21', INTERVAL 1 MONTH) AND REGISTRO<='".$periodo."-20'
